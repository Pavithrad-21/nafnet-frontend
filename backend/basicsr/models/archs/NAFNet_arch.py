...
VERIFIED CORRECT CONFIG for NAFNet-GoPro-width32:
...
def create_nafnet_gopro():
    """
    VERIFIED correct NAFNet config for NAFNet-GoPro-width32.pth
    Parameters: 29.16M  ✅
    """
    return NAFNet(
        img_channel=3,
        width=64,
        middle_blk_num=1,          # ← was 1 (WRONG), must be 12
        enc_blk_nums=[1, 1, 1, 28],  # ← was [1,1,1,28] (WRONG)
        dec_blk_nums=[1, 1, 1, 1],  # ← was [1,1,1,1] (WRONG)
    )
